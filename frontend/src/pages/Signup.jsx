      ...
      <div className='max-w-[1170px] mx-auto'>
        <div className="grid grid-cols-1 lg:grid-cols-2">
          ...
          <div className='hidden lg:block bg-primaryColor rounded-l-lg'>
            <figure className='rounded-l-lg'>
              <img src={signupImg} alt="image" className='w-full rounded-l-lg' />
            </figure>
          </div>
       ...
       border-primaryColor flex items-center justify-center'>
                ...
                <div className='relative w-[130px] h-[50px]'>
                  <input type="file" onChange={handleFileInputChange} name='photo' id='customFile' accept='.jpg, .png'
                    className='absolute top-0 left-0 w-full h-full opacity-0 cursor-pointer' />

                  <label htmlFor="customFile" className='absolute top-0 left-0 w-full h-full
         flex items-center px-[0.75rem] py-[0.375rem] text-[15px] leading-6 
         overflow-hidden bg-[#0066ff46] text-headingColor font-semibold rounded-lg truncate cursor-pointer'>
              ...
              <p className='mt-5 text-textColor text-center'>Already have an account?
                <Link
                  className='text-primaryColor font-medium ml-1' to='/login'>Login</Link></p>
