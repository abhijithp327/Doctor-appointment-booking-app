          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-[30px] mt-[30px] lg:mt-[55px]">
            ...
            <div className='py-[30px] px-5'>
              ...
              <div className="mt-[30px]">
                ...
                <Link className='w-[44px] h-[44px] rounded-full border border-solid border-[#181A1E] mt-[30px] mx-auto flex items-center
          justify-center group hover:bg-primaryColor hover:border-none' to='/doctors'>
      ...
      <section>
        <div className="container">
          <div className="flex items-center justify-between flex-col lg:flex-row">
            ...
            <div className="relative z-10 xl:w-[770px] flex justify-end mt-[15px] lg:mt-0">
              <img src={featureImg} alt="image" className='w-3/4' />

              <div className='w-[150px] lg:w-[240px] bg-white absolute bottom-[50px] left-0 md:bottom-[100px]
