...
import DoctorAbout from './DotorAbout';
          ...
          <div className='md:col-span-2'>
            <div className="flex items-center gap-5">
              <figure className='max-w-[200px] max-h-[200px]'>
                <img className='w-full' src={doctorImg} alt="doctor" />
              </figure>
              ...
              <div>
                ...
                <h3 className='text-headingColor text-[22px] leading-9 mt-3 font-bold'>Dr. Abhijith p</h3>
                <div className="flex items-center gap-[6px]">
                  ...
                  <span className='text-[14px] leading-5 lg:text-[16px] lg:leading-7  text-textColor font-[400]'>(279)</span>


                </div>

                <p className='text__para text-[14px] leading-6 md:text-[15px] lg:max-w-[390px]'>Surgeons diagnose and treat injuries or illnesses in a patient. They operate on patients to treat injuries and deformities including cleft palates.</p>
